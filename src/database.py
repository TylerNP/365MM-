...
watched_movies = sqlalchemy.Table("watched_movies", metadata_obj, autoload_with=engine)
ratings = sqlalchemy.Table("ratings", metadata_obj, autoload_with=engine)
liked_movies = sqlalchemy.Table("liked_movies", metadata_obj, autoload_with=engine)
